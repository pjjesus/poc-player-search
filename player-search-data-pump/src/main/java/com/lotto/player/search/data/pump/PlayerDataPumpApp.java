package com.lotto.player.search.data.pump;
...
@EnableMongoRepositories(basePackages = {"com.lotto.player.search.data.pump.repositories.mongo"})
@EnableElasticsearchRepositories(basePackages = {"com.lotto.player.search.data.pump.repositories.es"})
